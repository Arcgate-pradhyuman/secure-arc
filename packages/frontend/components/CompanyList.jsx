...
const CompanyCard = ({ company, onSelect }) => (
    ...
    >
        <Box boxSize="60px">
            <Image src={company.image} alt={company.name} objectFit="cover" boxSize="full" />
        </Box>
...
const CompanyDetails = ({ company, onBack }) => (
    <Box p={4} borderWidth="1px" borderRadius="lg">
        <Image src={company.image} alt={company.name} objectFit="cover" w="full" maxH="200px" />
        <Text fontWeight="bold" mt={2}>{company.name}</Text>
